...
//@Valid anotasyonu, gelen verilerin belirli kurallara uygun olup olmadığını kontrol eden bir
// validasyon mekanizmasıdır. Projenizden örneklerle açıklayayım:
   // mesela Student deki fieldlerde belirlediğimiz koşulları kontrol eder.
   // Eğer herhangi bir kural ihlal edilirse MethodArgumentNotValidException fırlatılır

        // @NotNull        // değer null olamaz
        // @NotEmpty       // koleksiyon/dizi boş olamaz
        // @NotBlank       // String boş veya sadece boşluk karakteri içeremez
        // @Size          // uzunluk kontrolü
        // @Min           // minimum sayısal değer
        // @Max           // maksimum sayısal değer
        // @Email         // email format kontrolü
        // @Pattern       // regex ile format kontrolü
        // @Past          // geçmiş tarih olmalı
